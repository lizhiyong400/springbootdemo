package com.ssmspringboot.springbootdemo.mq.UserProducer;

import com.alibaba.fastjson.JSON;
import com.ssmspringboot.springbootdemo.mq.UserContent;
...
public class UserProducer {
    ...
    public void produder() {
        ...
        try {
            producer.start();
            for (int i = 0; i < 100; i++) {
                //UserContent.builder().username("zhiyong").pwd("123");
                String jsonstr = JSON.toJSONString(UserContent.builder().username("zhiyong").pwd("123"));
